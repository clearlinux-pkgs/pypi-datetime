...
Source0  : https://files.pythonhosted.org/packages/2f/66/e284b9978fede35185e5d18fb3ae855b8f573d8c90a56de5f6d03e8ef99e/DateTime-5.5.tar.gz
...
%prep
%setup -q -n DateTime-5.5
cd %{_builddir}/DateTime-5.5
pushd ..
cp -a DateTime-5.5 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1711032358
