...
Version  : 5.1
Release  : 30
URL      : https://files.pythonhosted.org/packages/0b/e0/803b837cbeaa04150eb434c4101b8e2ec047ec3e9ee9abd77d07cbafd6d6/DateTime-5.1.tar.gz
Source0  : https://files.pythonhosted.org/packages/0b/e0/803b837cbeaa04150eb434c4101b8e2ec047ec3e9ee9abd77d07cbafd6d6/DateTime-5.1.tar.gz
...
%prep
%setup -q -n DateTime-5.1
cd %{_builddir}/DateTime-5.1
pushd ..
cp -a DateTime-5.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1678890471
